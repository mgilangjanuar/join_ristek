						...
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-4 text-center ">
									...
									<a href="<?= site_url('ssologin') ?>" class="btn btn-link center-block disabled" role="button" disabled>SSO Login</a>	
									<?php else: ?>
									<a href="<?= site_url('ssologin') ?>" class="btn btn-link center-block" role="button">SSO Login</a>	
									<?php endif; ?>
								</div>												
							</div>
						</div>
